                ...
                <!-- <v-card class="mb-3">
                    <v-card-text>
                        ...
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
                            Quisquam, eum perspiciatis! Veniam tenetur, fugit quisquam ut
                             neque cum quos quidem fugiat odio ad accusamus quas sunt quo 
                             necessitatibus? Perspiciatis, possimus.
                        </p>
                        <v-btn color="warning" class="mr-2">Editar</v-btn>
...
export default {
    data (){
        return{
            listaTareas: [
                {id: 1, titulo: 'Título tarea #1', descripcion: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam, eum perspiciatis! Veniam tenetur, fugit quisquam utneque cum quos quidem fugiat odio ad accusamus quas sunt quo necessitatibus? Perspiciatis, possimus.'},
                {id: 2, titulo: 'Título tarea #2', descripcion: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam, eum perspiciatis! Veniam tenetur, fugit quisquam utneque cum quos quidem fugiat odio ad accusamus quas sunt quo necessitatibus? Perspiciatis, possimus.'}
            ],
            titulo: '',
            descripcion: '',
            mensaje: '',
